...
![AWS Example Architecture v1](https://us-east-1-anand-files.s3.us-east-1.amazonaws.com/aws/aws-example-architecture-v1.jpg)

![AWS Example Architecture v2](https://us-east-1-anand-files.s3.us-east-1.amazonaws.com/aws/aws-example-architecture-v2.jpg)

![AWS Example Architecture v3](https://us-east-1-anand-files.s3.amazonaws.com/aws/aws-example-architecture-v3.jpg)